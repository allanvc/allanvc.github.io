...
API_key <- readLines(con <- file("../../../API_key.txt"))
...
```{r, preview=FALSE, echo=TRUE, fig.height=5, fig.width=8, message=FALSE, fig.align='center'}
...
```{r, preview=TRUE, fig.height=5, fig.width=8, echo=TRUE, message=FALSE, fig.align='center'}
## Plot:
...
```{r, preview=FALSE, fig.height=4.5, fig.width=6.5, echo=TRUE, message=FALSE}
## simple 2D plot:
...
```{r, preview=FALSE, fig.height=4, fig.width=6, echo=TRUE, message=FALSE}
